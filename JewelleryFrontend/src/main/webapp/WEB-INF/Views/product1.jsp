...
<c:url value ="/resources/js/jss"  var="js"/>
	...
	<section class="bgwhite p-t-66 p-b-60">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6 p-b-30" style="margin-left:-150px;">
					<c:url value="/addprod" var="product1"/>
					<form:form  action ="${product1}" method ="post" commandName="product" enctype="Multipart/form-data">
						...
						<form:input type="text" name="name" placeholder="product Id" path="Id"/>
						</div>

						<div class="bo4 of-hidden size15 m-b-20">
							<form:input  type="text" name="phone-number" placeholder="product-Name" path="Name"/>
						</div>
						<div class="bo4 of-hidden size15 m-b-20">
                        <form:input  type="text" name="name" placeholder="product price" path="Price"/>
						</div>

						<div class="bo4 of-hidden size15 m-b-20">
							<form:input type="text" name="phone-number" placeholder="product-description" path="description"/>
						</div>
						<div class="bo4 of-hidden size15 m-b-20">
							<form:input  type="text" name="phone-number" path="Quantity"/>
						</div>
...
<table style="width:100%">
  ...
  <tr>
    ...
    <td>${prod.getName()} </td>
    <td>
  <a href="<c:url value="/editProduct1/${prod.getId()}"/>"> Edit</a>/<a href="<c:url value="/deleteProduct1/${prod.getId()}"/>">Delete</a>
  </td>
