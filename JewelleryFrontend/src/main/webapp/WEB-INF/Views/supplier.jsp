				...
				<div class="col-md-6 p-b-30" style="margin-left:-150px;">
					...
					<form:form  action ="${supplier}" method ="post" commandName="supplier">
						...
						<div class="bo4 of-hidden size15 m-b-20">
								...
								<form:input type="text" name="id" placeholder="Supplier Id" path="Id"/>
						</div>

						<div class="bo4 of-hidden size15 m-b-20">
							<form:input  type="text" name="phone-number" placeholder="Supplier-Name" path="Name"/>
						</div>
						<div class="bo4 of-hidden size15 m-b-20">
                        <form:input  type="text" name="name" placeholder="Supplier email-id" path="EmailId"/>
						</div>

						<div class="bo4 of-hidden size15 m-b-20">
							<form:input type="text" name="phone-number" placeholder="Supplier address" path="Address"/>
						</div>
...
<table style="width:100%">
  ...
  <c1:forEach items="${Supplieries}" var="supplier">
  <tr>
    <td>${supplier.getId()} </td>
    <td>${supplier.getName()} </td>
    <td>
  <a href="<c:url value="/editSupplier/${supplier.getId()}"/>"> Edit</a>/<a href="<c:url value="/deleteSupplier/${supplier.getId()}"/>">Delete</a>
  </td>
  </tr>
  </c1:forEach>
  			</table>
