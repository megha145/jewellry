	...
	<section class="bgwhite p-t-66 p-b-60">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-4 p-b-30" style="margin-left:-150px;">
				<c:url value="/addcat" var="cat"/>
					<form:form  action ="${cat}" method ="post" commandName="category">
		                ...
		                <form:input type="text" name="id" placeholder="Category Id" path="catId"/>
						</div>

						<div class="bo4 of-hidden size15 m-b-20">
							<form:input type ="text" name="catname" placeholder="Category Name" path="catName"/>
						</div>
...
<table style="width:100%">
  ...
  <td>
  <a href="<c:url value="/editCategory/${cat.getCatId()}"/>"> Edit</a>/<a href="<c:url value="/deleteCategory/${cat.getCatId()}"/>">Delete</a>
  </td>
